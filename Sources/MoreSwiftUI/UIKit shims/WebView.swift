...
public class WebViewStateModel: ObservableObject {
    @Published var pageTitle: String = "WebView"
...
public struct WebView: View {
    ...
    */
    public init(uRLRequest: URLRequest, webViewStateModel: WebViewStateModel, onNavigationAction: ((_ navigationAction: WebView.NavigationAction) -> Void)?) {
